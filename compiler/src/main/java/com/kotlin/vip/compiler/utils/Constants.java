package com.kotlin.vip.compiler.utils;
...
public class Constants {
    ...
    // 注解处理器中支持的注解类型
    public static final String AROUTER_ANNOTATION_TYPES = "com.kotlin.vip.annotation.ARouter";
    ...
    // 包名前缀封装
    static final String BASE_PACKAGE = "com.kotlin.vip.arouterapi";
    // 路由组Group加载接口
