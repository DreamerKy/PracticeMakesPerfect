package com.cardinfo.proxy;



import com.cardinfo.proxy.dynamic.MarkCompany;
import com.cardinfo.proxy.dynamic.ProxyUtils;
...
//
//        MarkCompany markCompany = new MarkCompany();
//        WomanToolsFactory proxyInstance = (WomanToolsFactory) markCompany.getProxyInstance(WomanToolsFactory.class);
//        proxyInstance.saleWomanTools(2.0f);
