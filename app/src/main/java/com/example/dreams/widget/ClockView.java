...
public class ClockView extends View {
    ...
    private static final int DEFAULT_STROKE_WIDTH = 16;
    ...
    private static final float PADDING = Utils.dp2px(8);
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        System.out.println("mRealRadius : " + mRealRadius);
...
//        canvas.translate(getPaddingLeft() + radiusDial, getPaddingTop() + radiusDial);
    ...
    private void drawPointer(Canvas canvas) {
        ...
        pointerPath.moveTo(radiusDial - strokeWidthDial - dp2px(15), 0);
        pointerPath.lineTo(0, -dp2px(5));
        pointerPath.lineTo(-12, 0);
        pointerPath.lineTo(0, dp2px(5));
        pointerPath.close();
        canvas.drawPath(pointerPath, titlePaint);
        canvas.drawOval(- PADDING,  - PADDING, PADDING, PADDING, titlePaint);
    }
